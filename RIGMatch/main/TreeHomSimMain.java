...
public class TreeHomSimMain {
	...
	public TreeHomSimMain(String dataFN, String queryFN) {
		...
		//outFileN = Consts.OUTDIR_TREE + "sum_" + fn + "_Tree_FltSim" + suffix;
		outFileN = Consts.OUTDIR + "sum_" + fn + "_Tree_FltSim" + suffix;
		stats = new QueryEvalStats(dataFileN, queryFileN, "TreeEval_FltSim");
	...
	private void evaluate() {
		...
		for (int i = 0; i < Flags.REPEATS; i++) {
			for (int Q = 0; Q < queries.size(); Q++) {
				...
				TreeHomSim eva = new TreeHomSim(query, fb, bfl);
	...
	public static void main(String[] args) {
		...
		TreeHomSimMain demain = new TreeHomSimMain(dataFileN, queryFileN);
