...
public class GraHomTJMain {
	...
	public GraHomTJMain(String dataFN, String queryFN) {
	...
	private void evaluate() {
		...
		for (int i = 0; i < Flags.REPEATS; i++) {
			for (int Q = 0; Q < queries.size(); Q++) {
				...
				GraHomTJ eva = new GraHomTJ(query, invLstsByID, bitsByIDArr, fb, bfl);
	...
	public static void main(String[] args) {
		...
		GraHomTJMain demain = new GraHomTJMain(dataFileN, queryFileN);
